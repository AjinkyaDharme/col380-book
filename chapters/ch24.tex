% ============================================================
% ch24.tex  ---  Lecture 24: Parallel Algorithms
%               Prefix Sum and Radix Sort
% This file is part of the col380-book repository.
% Compile via the top-level main.tex using ppbook.cls.
% ============================================================

\chapter{Parallel Algorithms --- Prefix Sum and Radix Sort}
...
the \emph{Hillis \& Steele} algorithm (1986)~\cite{hillis1986} and the \emph{Blelloch} algorithm
(1990)~\cite{blelloch1990} --- and analyse their work, depth, and PRAM complexity. Radix sort, a
...
The Hillis \& Steele algorithm (1986)~\cite{hillis1986}, discussed in the previous lecture,
...
\end{lstlisting}
This is exactly the algorithm given by Blelloch (1990)~\cite{blelloch1990}.
\end{ppnote}
...
$O(\log n / \log\log n)$ (Cole, 1986; Blelloch, 1990~\cite{blelloch1990}, ch.~4). Without
...
\begin{ppkey}
\textbf{Brent's Theorem (1974)~\cite{brent1974}.} Let a parallel algorithm have total work
...
\begin{ppexercises}
\textbf{Exercise 24.1.} State the formal definition of the
...
\begin{ppexercises}
\textbf{Exercise 24.2.} Apply Hillis \& Steele to the array
...
\begin{ppexercises}
\textbf{Exercise 24.3.} Why is Blelloch's algorithm work-efficient
...
\begin{ppexercises}
\textbf{Exercise 24.4.} Show how to convert an inclusive scan into an
...
\begin{ppexercises}
\textbf{Exercise 24.5.} On an EREW PRAM with $p = n$ processors,
...
\begin{ppexercises}
\textbf{Exercise 24.6.} Trace the in-place up-sweep of Blelloch's
...
\begin{ppexercises}
\textbf{Exercise 24.7.} A radix-sort pass uses radix $k = 256$ on
...
\begin{ppexercises}
\textbf{Exercise 24.8.} Why must the parallel scatter step in radix sort
...
\begin{ppexercises}
\textbf{Exercise 24.9.} On the input $A = [27,\ 11,\ 51,\ 5,\ 49,\
...
\begin{ppexercises}
\textbf{Exercise 24.10.} Suppose someone proposes to skip the prefix-sum
...
\begin{ppexercises}
\textbf{Exercise 24.11.} Exercise~24.6 left the up-sweep of Blelloch's
...
\begin{ppexercises}
\textbf{Exercise 24.12.} Using the work-count results from
...
\begin{ppexercises}
\textbf{Exercise 24.13.} You have $n = 2^{20}$ keys, $p = 32$
...
\begin{ppexercises}
\textbf{Exercise 24.14.} Both Hillis \& Steele and Blelloch achieve
...
%-------- NEW EXERCISES (24.15--24.18) --------

\begin{ppexercises}
\textbf{Exercise 24.15 (Brent's Theorem applied).}
...
\begin{ppexercises}
\textbf{Exercise 24.16 (Scan with non-addition operators).}
...
\begin{ppexercises}
\textbf{Exercise 24.17 (Parallel radix sort: scaling $p$).}
...
\begin{ppexercises}
\textbf{Exercise 24.18 (Stability verification by example).}
...
% ----------------------------------------------------------
% References for this chapter are collected in backmatter/bibliography.bib.
% Key citations: \cite{sharma2024lec24}, \cite{blelloch1990},
% \cite{hillis1986}, \cite{brent1974}, \cite{grama2003},
% \cite{kirk2016}, \cite{harris2007}.
% The full bibliography is rendered at the end of the book via main.tex.
...
\begin{itemize}[leftmargin=*]
  ...
  \begin{itemize}
    \item \emph{Primary Author:} Overview, Key Learning Outcomes, key takeaways and
          Prefix Sum problem statement (Sections 24.1--24.3).
    \item \emph{Primary Author:} Hillis \& Steele recap and analysis
          (Section 24.4).
    \item \emph{Primary Author:} Side-by-Side Trace: Hillis \& Steele vs.\ Blelloch (Sections 24.7.1 and 24.7.2).
    \item \emph{Primary Author:} Parallel Radix Sort algorithm, PRAM Analysis, and time complexity illustrations (Section 24.8).
    \item \emph{Primary Author:} Problems and Solutions (Section 24.9).
  \end{itemize}

  \item \textbf{Naman Goyal (2022CS11080)}
  \begin{itemize}
    \item \emph{Primary Author:} Blelloch's up-sweep and down-sweep
          phases (Sections 24.5.1--24.5.2).
    \item \emph{Primary Author:} Worked examples and tree diagrams for
          the scan algorithms.
    \item \emph{Primary Author:} Exercises 24.1--24.10.
  ...
  \begin{itemize}
    ...
    (Section 24.5.3)
    \item \emph{Primary Author:} Side by Side trace : Hillis and Steele vs Blelloch (Section 24.7.3)
    \item \emph{Primary Author:} Stability of Parallel Radix Sort and Worked Example (Sections 24.8.2 and 24.8.4).
  ...
  \begin{itemize}
    \item \emph{Primary Author:} Section~\ref{sec:sidebyside} ---
          ...
          work-efficiency.
    \item \emph{Primary Author:} Exercises 24.11--24.14 and their
  ...
  \begin{itemize}
    ...
    \item \emph{Primary Author:} Extended note on the inclusive
          down-sweep (Section 24.5.2) explaining why invertibility of
    ...
    \item \emph{Primary Author:} Exercises 24.15--24.18 and their full
